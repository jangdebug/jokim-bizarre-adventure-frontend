...
export default function EventListContentItem({
  eventListData,
}: {
  eventListData: eventListType
}) {
  return (
    <>
        ...
        <Link href={`/product/${eventListData.id}`}>
          <div className="flex mb-7 items-start">
            ...
            <div className=" w-1/2">
              ...
              <p className="mb-2 text-sm leading-5 w-full text-[#404040]">
                {eventListData.eventDescription}
              </p>
            </div>
          </div>
        </Link>
